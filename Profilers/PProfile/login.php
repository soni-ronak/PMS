        ...
        <div class="templatemo-content-container">
          <div class="templatemo-flex-row flex-content-row">
            <div class="templatemo-content-widget white-bg col-2">
              ...
              <div class="square"></div>
              <h2 class="templatemo-inline-block">Welcome to VIT-OPMS</h2>
              <p></p>
              <p>Hello Officer! Have a great day with us! With VIT-PMS Account, You can add drives, Send Notifications and View the Eligibility Criteria of Students.</p>
