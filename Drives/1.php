				...
				<div class="top-nav">
					...
					<ul class="nav1">
						<li class="hvr-sweep-to-bottom">
								<a href="../Homepage/index.php">VIT-PMS<i>Goto Placement Homepage</i></a>
							</li>
						<li class="hvr-sweep-to-bottom">
				...
				<div class="col-md-7 a-banner-bottom-text">
					<div class="jumbotron banner-bottom-left wow fadeInLeft animated animated" data-wow-delay="0.5s" style="visibility: visible; -webkit-animation-delay: 0.5s;">
					  <h3>Placement and Training Department</h3>
						<h5></span></h5>
						<p>India is booming and the market is needy for skills, investment and wise leadership. As one of the educational campus in the region, the Vidhyanagari works hard to ensure that the work we do is actionable and relevant for our continent and that our students are engaged and ready to make a contribution to its sustainable development from grass root level to professional courses.

If you want to study with the best, look no further. The Vidhyanagari is recognised as a top performer with excellence of quality. We are one of the leading educational campus to provide quality education with core focus og student's development.
			...
			<div class="banner-bottom-grids a-banner-bottom-grids">
				...
				<div class="col-md-7 a-banner-bottom-text">
					<div class="jumbotron banner-bottom-left wow fadeInLeft animated animated" data-wow-delay="0.5s" style="visibility: visible; -webkit-animation-delay: 0.5s;">
						...
						<h5></span></h5>
						<p>If you want to study with the best, look no further. The Vidhyanagari is recognised as a top performer with excellence of quality. We are one of the leading educational campus to provide quality education with core focus og student's development.
		...
		<div class="footer">
			...
			<div class="container">
				...
				<div class="col-md-3 footer-middle wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h3>Address</h3>
					<div class="address">
						<p>Motipura Bypass Road,
						<span>On the bank of River Hathmati,</span>
						Himmatnagar - 383001.
						</p>
					</div>
					<div class="phone">
					<p>Telephone: +91 (02772) 244621
						<span>FAX:  +91 (02772) 245120</span>
						E-mail: <a href="mailto:info@vidhyanagari.org">info@vidhyanagari.org</a>
					</p>
					</div>
				</div>
				<div class="col-md-3 footer-right  wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h6 style="color: white">VIDHYANAGRI INSTITUTE OF TECHNOLOGY</h6>
					<h4>
			...
			<div class="container">
              ...
              <a href="https://byteroots.in" target="_parent">ByteRoots</a>
				...
				<div class="copyright-right wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<ul>
						<li>
							<a href="https://x.com/byteroots" class="twitter"> </a>
						</li>
						<li>
							<a href="https://facebook.com/byteroots" class="twitter facebook"> </a>
						</li>
						
						<li>
							<a href="https://pinterest.com/byteroots" class="twitter pinterest"> </a>
						</li>
						<li>
							<a href="https://linkedin.com/in/byteroots" class="twitter linkedin"> </a>
						</li>
						<li>
							<a href="https://instagram.com/byteroots" class="twitter instagram"> </a>
						</li>
					</ul>
				</div>
				<div class="clearfix"></div>
