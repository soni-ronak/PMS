          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
               <li><a href="../../Homepage/index.php">Home VIT-PMS</a></li>
...
$RESULT=mysql_query("SELECT DISTINCT count(CompanyName) from addpdrive where PVenue LIKE '%VIT%' AND YEAR(Date)=YEAR(NOW())");
...
?>		
          ...
          <footer class="text-right">
            <p>Copyright &copy; 2001-2023 Vidhyanagri Institute Of Technology
            | Developed by <a href="https://byteroots.in" target="_parent">ByteRoots</a></p>
          </footer>         
        </div>
      </div>
    </div>    
